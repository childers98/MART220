...
//     // fire = loadImage('assets/blob.png');
//     newFont = loadFont('assets/Pacifico-Regular.ttf');
// }
...
function draw() {
    ...
    // electricY += electricSpeed;
    // if(electricY >= height - electric.height || electricY  <= electric.height/8)
    // {
    //     electricSpeed *= -1;
    // }
    ...
    // blobY += blobSpeed;
    // if(blobY >= height - blob.height || blobY  <= blob.height/8)
    // {
    //     blobSpeed *= -1;
    // }
    // blobX += blobSpeed;
    // if(blobX >= width - blob.width || blobX  <= blob.width/8)
    // {
    //     blobSpeed *= -1;
    // }
    ...
    */
    ...
    //         Speed electric= random(1,10);
    //         blobSpeed = random(1,10);
